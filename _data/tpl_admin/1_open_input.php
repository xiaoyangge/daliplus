...
<div class="search">
	...
	<tr>
		...
		<td><select name="keytype" id="keytype" onchange="update_select(this.value)">
			<?php $tmpid["num"] = 0;$keytype_list=is_array($keytype_list) ? $keytype_list : array();$tmpid = array();$tmpid["total"] = count($keytype_list);$tmpid["index"] = -1;foreach($keytype_list as $key=>$value){ $tmpid["num"]++;$tmpid["index"]++; ?>
