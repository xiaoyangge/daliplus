<?php if(!defined("PHPOK_SET")){exit("<h1>Access Denied</h1>");} ?><input type="hidden" name="ext_form_id" id="ext_form_id" value="option_list,ext_select,put_order" />
<div class="table">
	<div class="title">
		属性列表：
		<span class="note">请选择复选框数据来源</span>
	</div>
	<div class="content">
		<table>
		<tr>
...
<div class="table">
	<div class="title">
		自定义选项：
		<span class="note">仅限于属性列表为空的情况下有效，这里一行一个值，复杂操作请到表单选项里维护</span>
	</div>
	<div class="content">
