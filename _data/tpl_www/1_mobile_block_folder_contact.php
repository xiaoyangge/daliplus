...
<div class="am-panel am-panel-default">
	<div class="am-panel-hd">
		<h3 class="am-panel-title"><?php echo $contactus['title'];?><?php if($showmore){ ?><a href="<?php echo $contactus['url'];?>" class="am-fr more">更多 <span class="am-icon-angle-right"></span></a><?php } ?></h3>
	</div>
