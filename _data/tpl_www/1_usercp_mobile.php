<?php if(!defined("PHPOK_SET")){exit("<h1>Access Denied</h1>");} ?><?php $title = "修改手机号 - 会员中心";?><?php $this->assign("title",$title); ?><?php $this->output("header","file",true,false); ?>
		...
		<div class="am-panel am-panel-default">
			...
			<div class="am-panel-bd">
				...
				<div class="am-form-group">
					...
					<div class="am-u-sm-10"><input type="text" name="oldmobile" id="oldmobile" value="<?php echo $rs['mobile'];?>" class="input" disabled /></div>
				</div>
				<?php } ?>
				<div class="am-form-group">
					<label for="mobile" class="am-u-sm-2 am-form-label">名称</label>
					<div class="am-u-sm-<?php echo $sendsms ? 8 : 10;?>">
