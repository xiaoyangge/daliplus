...
<head>
	...
	<title><?php if($title){ ?><?php echo $title;?><?php } else { ?><?php echo $config['title'];?><?php } ?></title>
	...
	<link rel="stylesheet" type="text/css" href="tpl/www_mobile/css/style.css?t=5" />
	<?php if($css){ ?>
	...
	<script type="text/javascript" src="tpl/www_mobile/js/global.js" charset="utf-8"></script>
	<?php if($js){ ?>
